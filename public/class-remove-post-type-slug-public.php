...
class Remove_Post_Type_Slug_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Remove_Post_Type_Slug_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Remove_Post_Type_Slug_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/remove-post-type-slug-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/remove-post-type-slug-public.js', array( 'jquery' ), $this->version, false );
